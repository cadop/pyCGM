...
class TestAxisUtils(unittest.TestCase):
    ...
    def testfindJointC(self):
        a = [426.50338745, 262.65310669, 673.66247559]
        b = [308.38050472, 322.80342417, 937.98979061]
        c = [416.98687744, 266.22558594, 524.04089355]
        delta = 59.5
        expected = [364.17774614, 292.17051722, 515.19181496]
