...
class TestUpperBodyAxis(TestCase):
    ...
    def testHeadJC(self):
        ...
        for testcase in testcases:
            result = pyCGM.headJC(testcase[0], testcase[1])
    ...
    def testThoraxJC(self):
        ...
        for testcase in testcases:
            result = pyCGM.thoraxJC(testcase[0])
    ...
    def testFindShoulderJC(self):
        ...
        for testcase in testcases:
            with patch.object(pyCGM, 'findJointC', return_value=rand_coor) as mock_findJointC:
                result = pyCGM.findshoulderJC(testcase[0], testcase[1], testcase[2], testcase[3])
            ...
            np.testing.assert_almost_equal(testcase[4][0], mock_findJointC.call_args_list[0][0][0], rounding_precision)
            np.testing.assert_almost_equal(testcase[4][1], mock_findJointC.call_args_list[0][0][1], rounding_precision)
            np.testing.assert_almost_equal(testcase[4][2], mock_findJointC.call_args_list[0][0][2], rounding_precision)
            np.testing.assert_almost_equal(testcase[4][3], mock_findJointC.call_args_list[0][0][3], rounding_precision)

            # Asserting that the correct params were sent in the 2nd (left) call to findJointC
            np.testing.assert_almost_equal(testcase[5][0], mock_findJointC.call_args_list[1][0][0], rounding_precision)
            np.testing.assert_almost_equal(testcase[5][1], mock_findJointC.call_args_list[1][0][1], rounding_precision)
            np.testing.assert_almost_equal(testcase[5][2], mock_findJointC.call_args_list[1][0][2], rounding_precision)
            np.testing.assert_almost_equal(testcase[5][3], mock_findJointC.call_args_list[1][0][3], rounding_precision)
    ...
    def testShoulderAxisCalc(self):
           ...
           for testcase in testcases:
                result = pyCGM.shoulderAxisCalc(None, testcase[0], testcase[1], testcase[2])
    ...
    def testElbowJointCenter(self):
        ...
        for testcase in testcases:
            result = pyCGM.elbowJointCenter(testcase[0], testcase[1], testcase[2], testcase[3], testcase[4])
            ...
            np.testing.assert_almost_equal(result[2], testcase[5][2], rounding_precision)
    ...
    def testWristJointCenter(self):
        ...
        for testcase in testcases:
            result = pyCGM.wristJointCenter(None, None, None, testcase[0])
            np.testing.assert_almost_equal(result[0], testcase[1][0], rounding_precision)
            np.testing.assert_almost_equal(result[1], testcase[1][1], rounding_precision)
    ...
    def testHandJointCenter(self):
        ...
        for testcase in testcases:
            result = pyCGM.handJointCenter(testcase[0], testcase[1], testcase[2], testcase[3])
...
class TestLowerBodyAxis(TestCase):
    ...
    def testFootJointCenter(self):
        ...
        for testcase in testcases:
            result = pyCGM.footJointCenter(testcase[0], testcase[1], testcase[2], None, None)
            np.testing.assert_almost_equal(result[0], testcase[3][0], rounding_precision)
            np.testing.assert_almost_equal(result[1], testcase[3][1], rounding_precision)
            np.testing.assert_almost_equal(result[2], testcase[3][2], rounding_precision)

class TestAxisUtils(TestCase):
