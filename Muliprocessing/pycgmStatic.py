...
def getStatic(motionData,vsk,flat_foot=False):
	...
	calibratedMeasurements['LeftStaticPlantFlex'] = static[1][1]
	calibratedMeasurements['HeadOffset'] = staticHead
	# calibratedMeasurements['RightStaticRotOff'] = vsk['RightStaticRotOff']
	# calibratedMeasurements['RightStaticPlantFlex'] = vsk['RightStaticPlantFlex']
	# calibratedMeasurements['LeftStaticRotOff'] = vsk['LeftStaticRotOff']
	# calibratedMeasurements['LeftStaticPlantFlex'] = vsk['LeftStaticPlantFlex']
	# calibratedMeasurements['HeadOffset'] = vsk['HeadOffset']
