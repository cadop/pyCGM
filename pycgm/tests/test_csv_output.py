        ...
        for i in range(len(floats)):
            if i in index_to_header:
                ...
                if label is not None:
                    ...
                    arr[index] = floats[i]
                    arr[index + 1] = floats[i + 1]
                    arr[index + 2] = floats[i + 2]
        output.append(arr)
...
class TestCSVOutput:
    ...
    def setup_class(self):
        ...
        self.subject_59993_Frame = CGM(self.filename_59993_Frame_static, self.filename_59993_Frame_dynamic,
                                       self.filename_59993_Frame_vsk, start=0, end=500)
        ...
        self.expected_Test_Files = load_output_csv(expected_file, header_line_number=2, first_output_row=5,
                                                   first_output_col=2, label_prefix_len=5)
