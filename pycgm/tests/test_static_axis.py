...
class TestPycgmStaticAxis():
    ...
    def test_pelvisJointCenter(self, frame, expected):
        ...
        static.py, defined as pelvisJointCenter(frame).
        ...
        line of static.py as lists cannot be divided by floats:
        origin = (RASI+LASI)/2.0
        """
        result = static.pelvisJointCenter(frame)
    ...
    def test_hipJointCenter(self, pel_origin, pel_x, pel_y, pel_z, vsk,
        ...
        static.py, defined as hipJointCenter(frame, pel_origin, pel_x,
        pel_y, pel_z, vsk).
        ...
        ints or floats.
        """
        result = static.hipJointCenter(None, pel_origin, pel_x, pel_y, pel_z,
                                       vsk)
        np.testing.assert_almost_equal(result[0], expected[0],
                                       rounding_precision)
        np.testing.assert_almost_equal(result[1], expected[1],
    ...
    def test_hipAxisCenter(self, l_hip_jc, r_hip_jc, pelvis_axis, expected):
        ...
        static.py, defined as hipAxisCenter(l_hip_jc, r_hip_jc,
        pelvis_axis).
        ...
        """
        result = static.hipAxisCenter(l_hip_jc, r_hip_jc, pelvis_axis)
        np.testing.assert_almost_equal(result[0], expected[0],
                                       rounding_precision)
        np.testing.assert_almost_equal(result[1], expected[1],
                                       rounding_precision)
    ...
    def test_kneeJointCenter(self, frame, hip_JC, vsk, mockReturnVal,
        ...
        static.py, defined as kneeJointCenter(frame, hip_JC, delta, vsk).
        This test takes 6 parameters:
            frame: dictionary of marker lists
        ...
        following lines of static.py as lists cannot be subtracted by each
        other:
            thi_kne_R = RTHI-RKNE
            thi_kne_L = LTHI-LKNE
        """
        with patch.object(static, 'findJointC',
                          side_effect=mockReturnVal) as mock_findJointC:
            result = static.kneeJointCenter(frame, hip_JC, None, vsk)
    ...
    def test_ankleJointCenter(self, frame, knee_JC, vsk, mockReturnVal,
        ...
        static.py, defined as ankleJointCenter(frame, knee_JC, delta,
        vsk).
        This test takes 6 parameters:
            frame: dictionary of marker lists
        ...
        with patch.object(static, 'findJointC',
                          side_effect=mockReturnVal) as mock_findJointC:
            result = static.ankleJointCenter(frame, knee_JC, None, vsk)
    ...
    def test_headJC(self, frame, expected):
        """
        This test provides coverage of the headJC function in static.py,
    ...
    def test_uncorrect_footaxis(self, frame, ankle_JC, expected):
        ...
        static.py, defined as uncorrect_footaxis(frame, ankle_JC).
        ...
        - the resulting output is correct when frame and ankle_JC are composed
          ...
          arrays of floats.
        """
        result = static.uncorrect_footaxis(frame, ankle_JC)
        np.testing.assert_almost_equal(result[0], expected[0],
                                       rounding_precision)
        np.testing.assert_almost_equal(result[1], expected[1],
                                       rounding_precision)
    ...
    def test_rotaxis_footflat(self, frame, ankle_JC, vsk, expected):
        ...
        static.py, defined as rotaxis_footflat(frame, ankle_JC, vsk).
        ...
        - the resulting output is correct when frame and ankle_JC are composed
          ...
          arrays of floats.
        """
        result = static.rotaxis_footflat(frame, ankle_JC, vsk)
        np.testing.assert_almost_equal(result[0], expected[0],
                                       rounding_precision)
        np.testing.assert_almost_equal(result[1], expected[1],
                                       rounding_precision)
    ...
    def test_rotaxis_nonfootflat(self, frame, ankle_JC, expected):
        ...
        static.py, defined as rotaxis_nonfootflat(frame, ankle_JC).
        ...
        - the resulting output is correct when frame and ankle_JC are composed
          ...
          arrays of floats.
        """
        result = static.rotaxis_nonfootflat(frame, ankle_JC)
        np.testing.assert_almost_equal(result[0], expected[0],
                                       rounding_precision)
        np.testing.assert_almost_equal(result[1], expected[1],
                                       rounding_precision)
    ...
    def test_findJointC(self, a, b, c, delta, expected):
        ...
        static.py, defined as findJointC(a, b, c, delta).
        This test takes 5 parameters:
        ...
        """
        result = static.findJointC(a, b, c, delta)
        np.testing.assert_almost_equal(result, expected, rounding_precision)
