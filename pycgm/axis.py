...
def elbowJointCenter(frame, thorax, shoulderJC, vsk=None):
    ...
    >>> [np.around(arr, 2) for arr in elbowJointCenter(frame,thorax,shoulderJC,vsk)] #doctest: +NORMALIZE_WHITESPACE
